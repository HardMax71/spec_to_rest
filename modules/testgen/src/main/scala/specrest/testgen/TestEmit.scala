...
object TestEmit:
  ...
  private def emitGo(profiled: ProfiledService): List[EmittedFile] =
    ...
    val structuralSkip = TestSkip(
      "<structural>",
      "structural_go_pending",
      "native OpenAPI structural fuzzing is not yet implemented for the Go " +
        "backend (#175); structural invariants are exercised by the stateful suite"
    )
    ...
    EmittedFile(FilePaths.AdminRouterFileGo, AdminRouterGo.emit(profiled)) ::
      ...
      List(
        ...
        EmittedFile(harness.structuralTestPath(serviceSnake), goStructuralPlaceholder()),
        EmittedFile(harness.skipsPath, skipsJson)
      )

  private def goStructuralPlaceholder(): String =
    s"""|//go:build conformance
       |
       |// Auto-generated by spec-to-rest --with-tests. Do not edit by hand.
       |//
       |// Native structural (OpenAPI) fuzzing is not yet implemented for the Go
       |// backend (#175). Structural invariants are exercised by the stateful
       |// suite; see tests/_testgen_skips.json.
       |
       |package tests
       |
       |import "testing"
       |
       |func TestStructuralPending(t *testing.T) {
       |\tt.Skip("native OpenAPI structural fuzzing pending (#175); structural " +
       |\t\t"invariants are exercised by the stateful suite")
       |}
       |""".stripMargin
  ...
  private def emitTs(profiled: ProfiledService): List[EmittedFile] =
    ...
    val structuralSkip = TestSkip(
      "<structural>",
      "structural_ts_pending",
      "native OpenAPI structural fuzzing is not yet implemented for the " +
        "TypeScript backend (#175); structural invariants are exercised by the " +
        "stateful suite"
    )
    val skipsJson = renderSkipsJson(
      ir.a,
    ...
    EmittedFile(FilePaths.AdminRouterFileTs, AdminRouterTs.emit(profiled)) ::
      ...
      List(
        ...
        EmittedFile(harness.statefulTestPath(serviceSnake), statefulOut.file),
        EmittedFile(harness.structuralTestPath(serviceSnake), tsStructuralPlaceholder(ir)),
        EmittedFile(harness.skipsPath, skipsJson)
      )

  private def tsStructuralPlaceholder(ir: ServiceIRFull): String =
    s"""|// Auto-generated by spec-to-rest --with-tests. Do not edit by hand.
        |//
        |// Native structural (OpenAPI) fuzzing is not yet implemented for the
        |// TypeScript backend (#175). Structural invariants are exercised by the
        |// stateful suite; see tests/_testgen_skips.json.
        |import { test } from "vitest";
        |
        |test.skip("${ir.a} structural: native OpenAPI fuzzing pending (#175)", () => {});
        |""".stripMargin
