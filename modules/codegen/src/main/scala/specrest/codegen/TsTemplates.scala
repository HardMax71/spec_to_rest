...
object TsTemplates:
  ...
  lazy val tsExpressPostgres: TsExpressPostgresTemplates =
    TsExpressPostgresTemplates(
      ...
      dafnyAdapter = load("src/dafnyKernel/adapter.ts.hbs"),
      dafnyCopyScript = load("scripts/copyKernel.mjs.hbs"),
