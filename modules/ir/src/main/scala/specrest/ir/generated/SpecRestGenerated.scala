...
object SpecRestGenerated {
  ...
  def set_target_entity_field_count(v: Option[nat], x1: analysis_signals): analysis_signals =
    (v, x1) match {
      case (v, AnalysisSignals(m, p, c, d, uu, w, f, t, h)) =>
        AnalysisSignals(m, p, c, d, v, w, f, t, h)
    }

  def signals_with_field_count(x0: analysis_signals): Option[nat] = x0 match {
  ...
  def decidePutPatch(
    ...
    signals_with_field_count(signals) match {
      ...
      case Some(wfc) =>
        entityFieldCount match {
          ...
          case Some(totalCount) =>
            val updated =
              set_target_entity_field_count(Some[nat](totalCount), signals): analysis_signals;
  ...
  def isCardinalityRhs(x0: expr_full, n: String): Boolean = (x0, n) match {
    case (UnaryOpF(UCardinality(), PreF(IdentifierF(m, uu), uv), uw), n) => m == n
    case (UnaryOpF(UCardinality(), IdentifierF(m, ux), uy), n)           => m == n
    case (BinaryOpF(BAdd(), inner, IntLitF(uz, va), vb), n) =>
      isCardinalityRhs(inner, n)
    case (BinaryOpF(BSub(), inner, IntLitF(vc, vd), ve), n) =>
      isCardinalityRhs(inner, n)
    case (BinaryOpF(BAnd(), va, vb, vc), vg)                         => false
    case (BinaryOpF(BOr(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BImplies(), va, vb, vc), vg)                     => false
    case (BinaryOpF(BIff(), va, vb, vc), vg)                         => false
    case (BinaryOpF(BEq(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BNeq(), va, vb, vc), vg)                         => false
    case (BinaryOpF(BLt(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BGt(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BLe(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BGe(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BIn(), va, vb, vc), vg)                          => false
    case (BinaryOpF(BNotIn(), va, vb, vc), vg)                       => false
    case (BinaryOpF(BSubset(), va, vb, vc), vg)                      => false
    case (BinaryOpF(BUnion(), va, vb, vc), vg)                       => false
    case (BinaryOpF(BIntersect(), va, vb, vc), vg)                   => false
    case (BinaryOpF(BDiff(), va, vb, vc), vg)                        => false
    case (BinaryOpF(BSub(), va, BinaryOpF(v, vd, ve, vf), vc), vg)   => false
    case (BinaryOpF(BSub(), va, UnaryOpF(v, vd, ve), vc), vg)        => false
    case (BinaryOpF(BSub(), va, QuantifierF(v, vd, ve, vf), vc), vg) => false
    case (BinaryOpF(BSub(), va, SomeWrapF(v, vd), vc), vg)           => false
    case (BinaryOpF(BSub(), va, TheF(v, vd, ve, vf), vc), vg)        => false
    case (BinaryOpF(BSub(), va, FieldAccessF(v, vd, ve), vc), vg)    => false
    case (BinaryOpF(BSub(), va, EnumAccessF(v, vd, ve), vc), vg)     => false
    case (BinaryOpF(BSub(), va, IndexF(v, vd, ve), vc), vg)          => false
    case (BinaryOpF(BSub(), va, CallF(v, vd, ve), vc), vg)           => false
    case (BinaryOpF(BSub(), va, PrimeF(v, vd), vc), vg)              => false
    case (BinaryOpF(BSub(), va, PreF(v, vd), vc), vg)                => false
    case (BinaryOpF(BSub(), va, WithF(v, vd, ve), vc), vg)           => false
    case (BinaryOpF(BSub(), va, IfF(v, vd, ve, vf), vc), vg)         => false
    case (BinaryOpF(BSub(), va, LetF(v, vd, ve, vf), vc), vg)        => false
    case (BinaryOpF(BSub(), va, LambdaF(v, vd, ve), vc), vg)         => false
    case (BinaryOpF(BSub(), va, ConstructorF(v, vd, ve), vc), vg)    => false
    case (BinaryOpF(BSub(), va, SetLiteralF(v, vd), vc), vg)         => false
    case (BinaryOpF(BSub(), va, MapLiteralF(v, vd), vc), vg)         => false
    case (BinaryOpF(BSub(), va, SetComprehensionF(v, vd, ve, vf), vc), vg) =>
      false
    case (BinaryOpF(BSub(), va, SeqLiteralF(v, vd), vc), vg)           => false
    case (BinaryOpF(BSub(), va, MatchesF(v, vd, ve), vc), vg)          => false
    case (BinaryOpF(BSub(), va, FloatLitF(v, vd), vc), vg)             => false
    case (BinaryOpF(BSub(), va, StringLitF(v, vd), vc), vg)            => false
    case (BinaryOpF(BSub(), va, BoolLitF(v, vd), vc), vg)              => false
    case (BinaryOpF(BSub(), va, NoneLitF(v), vc), vg)                  => false
    case (BinaryOpF(BSub(), va, IdentifierF(v, vd), vc), vg)           => false
    case (BinaryOpF(BMul(), va, vb, vc), vg)                           => false
    case (BinaryOpF(BDiv(), va, vb, vc), vg)                           => false
    case (BinaryOpF(v, va, BinaryOpF(vd, ve, vf, vh), vc), vg)         => false
    case (BinaryOpF(v, va, UnaryOpF(vd, ve, vf), vc), vg)              => false
    case (BinaryOpF(v, va, QuantifierF(vd, ve, vf, vh), vc), vg)       => false
    case (BinaryOpF(v, va, SomeWrapF(vd, ve), vc), vg)                 => false
    case (BinaryOpF(v, va, TheF(vd, ve, vf, vh), vc), vg)              => false
    case (BinaryOpF(v, va, FieldAccessF(vd, ve, vf), vc), vg)          => false
    case (BinaryOpF(v, va, EnumAccessF(vd, ve, vf), vc), vg)           => false
    case (BinaryOpF(v, va, IndexF(vd, ve, vf), vc), vg)                => false
    case (BinaryOpF(v, va, CallF(vd, ve, vf), vc), vg)                 => false
    case (BinaryOpF(v, va, PrimeF(vd, ve), vc), vg)                    => false
    case (BinaryOpF(v, va, PreF(vd, ve), vc), vg)                      => false
    case (BinaryOpF(v, va, WithF(vd, ve, vf), vc), vg)                 => false
    case (BinaryOpF(v, va, IfF(vd, ve, vf, vh), vc), vg)               => false
    case (BinaryOpF(v, va, LetF(vd, ve, vf, vh), vc), vg)              => false
    case (BinaryOpF(v, va, LambdaF(vd, ve, vf), vc), vg)               => false
    case (BinaryOpF(v, va, ConstructorF(vd, ve, vf), vc), vg)          => false
    case (BinaryOpF(v, va, SetLiteralF(vd, ve), vc), vg)               => false
    case (BinaryOpF(v, va, MapLiteralF(vd, ve), vc), vg)               => false
    case (BinaryOpF(v, va, SetComprehensionF(vd, ve, vf, vh), vc), vg) => false
    case (BinaryOpF(v, va, SeqLiteralF(vd, ve), vc), vg)               => false
    case (BinaryOpF(v, va, MatchesF(vd, ve, vf), vc), vg)              => false
    case (BinaryOpF(v, va, FloatLitF(vd, ve), vc), vg)                 => false
    case (BinaryOpF(v, va, StringLitF(vd, ve), vc), vg)                => false
    case (BinaryOpF(v, va, BoolLitF(vd, ve), vc), vg)                  => false
    case (BinaryOpF(v, va, NoneLitF(vd), vc), vg)                      => false
    case (BinaryOpF(v, va, IdentifierF(vd, ve), vc), vg)               => false
    case (UnaryOpF(UNot(), va, vb), vg)                                => false
    case (UnaryOpF(UNegate(), va, vb), vg)                             => false
    case (UnaryOpF(UPower(), va, vb), vg)                              => false
    case (UnaryOpF(v, BinaryOpF(vc, vd, ve, vh), vb), vg)              => false
    case (UnaryOpF(v, UnaryOpF(vc, vd, ve), vb), vg)                   => false
    case (UnaryOpF(v, QuantifierF(vc, vd, ve, vh), vb), vg)            => false
    case (UnaryOpF(v, SomeWrapF(vc, vd), vb), vg)                      => false
    case (UnaryOpF(v, TheF(vc, vd, ve, vh), vb), vg)                   => false
    case (UnaryOpF(v, FieldAccessF(vc, vd, ve), vb), vg)               => false
    case (UnaryOpF(v, EnumAccessF(vc, vd, ve), vb), vg)                => false
    case (UnaryOpF(v, IndexF(vc, vd, ve), vb), vg)                     => false
    case (UnaryOpF(v, CallF(vc, vd, ve), vb), vg)                      => false
    case (UnaryOpF(v, PrimeF(vc, vd), vb), vg)                         => false
    case (UnaryOpF(v, PreF(BinaryOpF(ve, vh, vi, vj), vd), vb), vg)    => false
    case (UnaryOpF(v, PreF(UnaryOpF(ve, vh, vi), vd), vb), vg)         => false
    case (UnaryOpF(v, PreF(QuantifierF(ve, vh, vi, vj), vd), vb), vg)  => false
    case (UnaryOpF(v, PreF(SomeWrapF(ve, vh), vd), vb), vg)            => false
    case (UnaryOpF(v, PreF(TheF(ve, vh, vi, vj), vd), vb), vg)         => false
    case (UnaryOpF(v, PreF(FieldAccessF(ve, vh, vi), vd), vb), vg)     => false
    case (UnaryOpF(v, PreF(EnumAccessF(ve, vh, vi), vd), vb), vg)      => false
    case (UnaryOpF(v, PreF(IndexF(ve, vh, vi), vd), vb), vg)           => false
    case (UnaryOpF(v, PreF(CallF(ve, vh, vi), vd), vb), vg)            => false
    case (UnaryOpF(v, PreF(PrimeF(ve, vh), vd), vb), vg)               => false
    case (UnaryOpF(v, PreF(PreF(ve, vh), vd), vb), vg)                 => false
    case (UnaryOpF(v, PreF(WithF(ve, vh, vi), vd), vb), vg)            => false
    case (UnaryOpF(v, PreF(IfF(ve, vh, vi, vj), vd), vb), vg)          => false
    case (UnaryOpF(v, PreF(LetF(ve, vh, vi, vj), vd), vb), vg)         => false
    case (UnaryOpF(v, PreF(LambdaF(ve, vh, vi), vd), vb), vg)          => false
    case (UnaryOpF(v, PreF(ConstructorF(ve, vh, vi), vd), vb), vg)     => false
    case (UnaryOpF(v, PreF(SetLiteralF(ve, vh), vd), vb), vg)          => false
    case (UnaryOpF(v, PreF(MapLiteralF(ve, vh), vd), vb), vg)          => false
    case (UnaryOpF(v, PreF(SetComprehensionF(ve, vh, vi, vj), vd), vb), vg) =>
      false
    case (UnaryOpF(v, PreF(SeqLiteralF(ve, vh), vd), vb), vg)     => false
    case (UnaryOpF(v, PreF(MatchesF(ve, vh, vi), vd), vb), vg)    => false
    case (UnaryOpF(v, PreF(IntLitF(ve, vh), vd), vb), vg)         => false
    case (UnaryOpF(v, PreF(FloatLitF(ve, vh), vd), vb), vg)       => false
    case (UnaryOpF(v, PreF(StringLitF(ve, vh), vd), vb), vg)      => false
    case (UnaryOpF(v, PreF(BoolLitF(ve, vh), vd), vb), vg)        => false
    case (UnaryOpF(v, PreF(NoneLitF(ve), vd), vb), vg)            => false
    case (UnaryOpF(v, WithF(vc, vd, ve), vb), vg)                 => false
    case (UnaryOpF(v, IfF(vc, vd, ve, vh), vb), vg)               => false
    case (UnaryOpF(v, LetF(vc, vd, ve, vh), vb), vg)              => false
    case (UnaryOpF(v, LambdaF(vc, vd, ve), vb), vg)               => false
    case (UnaryOpF(v, ConstructorF(vc, vd, ve), vb), vg)          => false
    case (UnaryOpF(v, SetLiteralF(vc, vd), vb), vg)               => false
    case (UnaryOpF(v, MapLiteralF(vc, vd), vb), vg)               => false
    case (UnaryOpF(v, SetComprehensionF(vc, vd, ve, vh), vb), vg) => false
    case (UnaryOpF(v, SeqLiteralF(vc, vd), vb), vg)               => false
    case (UnaryOpF(v, MatchesF(vc, vd, ve), vb), vg)              => false
    case (UnaryOpF(v, IntLitF(vc, vd), vb), vg)                   => false
    case (UnaryOpF(v, FloatLitF(vc, vd), vb), vg)                 => false
    case (UnaryOpF(v, StringLitF(vc, vd), vb), vg)                => false
    case (UnaryOpF(v, BoolLitF(vc, vd), vb), vg)                  => false
    case (UnaryOpF(v, NoneLitF(vc), vb), vg)                      => false
    case (QuantifierF(v, va, vb, vc), vg)                         => false
    case (SomeWrapF(v, va), vg)                                   => false
    case (TheF(v, va, vb, vc), vg)                                => false
    case (FieldAccessF(v, va, vb), vg)                            => false
    case (EnumAccessF(v, va, vb), vg)                             => false
    case (IndexF(v, va, vb), vg)                                  => false
    case (CallF(v, va, vb), vg)                                   => false
    case (PrimeF(v, va), vg)                                      => false
    case (PreF(v, va), vg)                                        => false
    case (WithF(v, va, vb), vg)                                   => false
    case (IfF(v, va, vb, vc), vg)                                 => false
    case (LetF(v, va, vb, vc), vg)                                => false
    case (LambdaF(v, va, vb), vg)                                 => false
    case (ConstructorF(v, va, vb), vg)                            => false
    case (SetLiteralF(v, va), vg)                                 => false
    case (MapLiteralF(v, va), vg)                                 => false
    case (SetComprehensionF(v, va, vb, vc), vg)                   => false
    case (SeqLiteralF(v, va), vg)                                 => false
    case (MatchesF(v, va, vb), vg)                                => false
    case (IntLitF(v, va), vg)                                     => false
    case (FloatLitF(v, va), vg)                                   => false
    case (StringLitF(v, va), vg)                                  => false
    case (BoolLitF(v, va), vg)                                    => false
    case (NoneLitF(v), vg)                                        => false
    case (IdentifierF(v, va), vg)                                 => false
  }
  ...
  def signals_filter_param_count(x0: analysis_signals): nat = x0 match {
    case AnalysisSignals(uu, uv, uw, ux, uy, uz, f, va, vb) => f
  }

  def signals_mutated_relations(x0: analysis_signals): List[String] = x0 match {
    case AnalysisSignals(m, uu, uv, uw, ux, uy, uz, va, vb) => m
  }

  def signals_creates_new_key(x0: analysis_signals): Boolean = x0 match {
    case AnalysisSignals(uu, uv, c, uw, ux, uy, uz, va, vb) => c
  }

  def signals_is_transition(x0: analysis_signals): Boolean = x0 match {
    case AnalysisSignals(uu, uv, uw, ux, uy, uz, va, t, vb) => t
  }

  def signals_deletes_key(x0: analysis_signals): Boolean = x0 match {
    ...
    signals_is_transition(signals) match {
      ...
      case false => signals_deletes_key(signals) match {
          ...
          case false => !nulla[String](signals_mutated_relations(signals)) &&
              ...
              case false => nulla[String](signals_mutated_relations(signals)) match {
                  case true =>
                    less_nat(nat_of_integer(BigInt(3)), signals_filter_param_count(signals)) match {
                      case true  => ClassificationResult(FilteredRead(), GET(), "M7", signals)
                      case false => ClassificationResult(Read(), GET(), "M2", signals)
                    }
                  case false => signals_has_collection_input(signals) &&
                      !nulla[String](signals_mutated_relations(signals)) match {
                      case true => ClassificationResult(BatchMutation(), POST(), "M9", signals)
                      case false => !nulla[String](signals_mutated_relations(signals)) &&
                          (!signals_creates_new_key(signals) &&
                            !signals_deletes_key(signals)) match {
