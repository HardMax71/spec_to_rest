...
def test_processor_recurses_into_lists_of_dicts():
    out = redact_sensitive(
        None,
        "info",
        {"event": "bulk", "users": [{"email": "a@b.com", "password": "p1"}, {"password": "p2"}]},
    )
