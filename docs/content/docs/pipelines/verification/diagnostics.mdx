...
| `4` | Soundness coverage gap: at least one check was skipped because its source exprs fall outside the domain of the Isabelle-verified `translate`, and no higher-precedence outcome (Backend / Violation / Translator) was raised. |
