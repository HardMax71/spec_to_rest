...
<img src="/spec_to_rest/grammar/expr-precedence.svg" alt="expr precedence chain (tightest → loosest)" className="my-4 mx-auto" />
...
<img src="/spec_to_rest/grammar/service-toplevel.svg" alt="service / entity / operation top-level structure" className="my-4 mx-auto" />

<img src="/spec_to_rest/grammar/operation-decl.svg" alt="operation declaration" className="my-4 mx-auto" />
