...
domain/frame axioms); set
literals and set-valued operations; FieldAccess on
...
1. Extend `proofs/isabelle/SpecRest/Translate.thy` and regenerate
...
- Research: [Spec Verification](/research/spec_verification/techniques), the full verification design
