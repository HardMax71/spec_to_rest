...
jobs:
  verify:
    ...
    steps:
      ...
      - run: ${{ steps.spec.outputs.binary-path }} compile --target python-fastapi-postgres --out generated fixtures/spec/url_shortener.spec
```
...
- name: Verify and compile
  ...
  run: |
    ...
    "$SPEC_TO_REST" compile --target python-fastapi-postgres --out generated fixtures/spec/url_shortener.spec
```
