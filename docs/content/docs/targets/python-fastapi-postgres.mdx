...
[Convention Engine](/docs/design/convention-engine) and the grammar rule is `conventionBlock` in
...
- **Convention overrides** declared inside a service-level `conventions { ... }` block. Each
  ...
  See [Convention Engine](/docs/design/convention-engine) for the full property list.
