...
- **Diff migrations.** Only the initial schema (`001_initial_schema.py`) is emitted. Spec
  changes require regenerating and hand-writing the migration delta.
  Tracked in [M7.5 (#56)](https://github.com/HardMax71/spec_to_rest/issues/56).
- **Triggers & partial indexes.** Tracked in [M7.6 (#57)](https://github.com/HardMax71/spec_to_rest/issues/57).
