...
generated. It uses the [Z3 SMT solver](https://github.com/Z3Prover/z3) via the Java bindings
bundled by [`tools.aqua:z3-turnkey`](https://github.com/tudo-aqua/z3-turnkey), which ships libz3
natively per-platform so no system install is required.
