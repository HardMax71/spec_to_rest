...
operation name. Today the only consumer is `inspect`; Phase 6's body-synthesis
work ([#27](https://github.com/HardMax71/spec_to_rest/issues/27)–[#32](https://github.com/HardMax71/spec_to_rest/issues/32))
will gate LLM calls on this same field.
