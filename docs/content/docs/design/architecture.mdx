...
- **Mechanically verified translator soundness:** Isabelle/HOL session under
  ...
  `Code_Target_Scala` extracts the verified translator to
  `modules/verify/.../cert/generated/SpecRestGenerated.scala`. Pivoted from Lean 4 in
...
soundness theorem in `proofs/isabelle/SpecRest/Soundness.thy`.
...
│               # · Narration · cert/generated/SpecRestGenerated.scala (Isabelle extract)
