...
| 7     | Multi-target codegen, Go/chi, TS/Express                      | **In progress.** Go/chi target shipped in [#33](https://github.com/HardMax71/spec_to_rest/issues/33); see [go-chi-postgres](/targets/go-chi-postgres). TS/Express target shipped in [#35](https://github.com/HardMax71/spec_to_rest/issues/35); see [ts-express-postgres](/targets/ts-express-postgres). Distribution [#34](https://github.com/HardMax71/spec_to_rest/issues/34), CLI polish [#36](https://github.com/HardMax71/spec_to_rest/issues/36) still open. |
