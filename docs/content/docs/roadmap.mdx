...
| 5     | Test generation (Hypothesis + Schemathesis)                    | **Largely shipped.** M5.2 stateful, M5.3 structural, M5.4 conformance runner, M5.6 custom strategies, M5.8 sensitive fields, M5.9 transitions, M5.10 built-in predicates all on `main`. Multi-target test gen is M5.11/M5.12, see [Test generation follow-ups](#test-generation-follow-ups). |
