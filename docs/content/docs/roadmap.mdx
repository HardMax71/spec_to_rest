...
cutover. See [research/10](/research/10_translator_soundness) for the trust-chain framing.
...
| Concern | Tracked in |
| ------- | ---------- |
| Operation decomposition (L2 fallback) | [#227](https://github.com/HardMax71/spec_to_rest/issues/227) closed wontfix-with-pivot, see [research/12](/research/12_compositional_synthesis_findings); replaced by M6.7 hint-augmentation |
