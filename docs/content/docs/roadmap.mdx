...
| Trust dimension ([#205](https://github.com/HardMax71/spec_to_rest/issues/205)) | Per-check `trust: "sound" \| "best-effort"`; new exit code 4 (`ExitCodes.Trust`); JSON `schemaVersion` 1->2 | shipped |
